    ...
    <>
      <div className=" about-us">
        ...
        <div className="max-width">
          ...
          <h2>What we do</h2>
          <p>
            We provide practical, accessible services both in the community and
            at private care locations. Our programs include medication
            ...
            public health agencies and community partners, we create care plans
        ...
        <div className="div-odd">
          <div className="max-width">
            ...
            <p>
              ...
              aim to assist healthcare organizations in enhancing patient care
          ...
          <ul>
            ...
            <li>
              Data-driven & ethical: We use best practices to protect privacy
      ...
      <div className="div-odd">
        <div className="max-width">
          <div className="connect-email">
            ...
            <p>
              📩 Email us at{" "}
              <a href="mailto:info@rozwonhealth.com" id="connect-email">
                info@rozwon.com
              </a>
            </p>
          </div>{" "}
